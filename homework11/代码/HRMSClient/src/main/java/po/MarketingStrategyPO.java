...
public class MarketingStrategyPO {
     ...
     */
    public MarketingStrategyPO(String name,marketingStrategy type,Date startTime,Date endTime,double discount,ArrayList<HotelinfoPO> hotels,
     ...
     * @param position
     */
    public MarketingStrategyPO(String name,marketingStrategy type,Date startTime,Date endTime,double discount,Image poster,
